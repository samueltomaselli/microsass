                  ...
                  <Table>
                    ...
                    <TableBody>
                      <TableRow>
                        ...
                        <TableCell className="hidden xl:table-column">Venda</TableCell>
                      ...
                      <TableRow>
                        ...
                        <TableCell className="hidden xl:table-column">Assinatura</TableCell>
                        <TableCell className="hidden xl:table-column">
                          <Badge className="text-xs" variant="outline">
                            Aprovado
                          </Badge>
                ...
                <CardContent className="grid gap-8">
                  <div className="flex items-center gap-4">
                    <Avatar className="hidden h-9 w-9 sm:flex">
                      <AvatarImage
                        src={`https://api.dicebear.com/9.x/lorelei/svg?seed=${Math.random()}`}
                        alt="Avatar"
                      />
